 ...
 **/
function getSquareOfRectangle(a, b) {
    return a * b;
}
 ...
 **/
function getSquareOfCylinder(r, h) {
 ...
 **/
function writerUlTimes(text, times = 3) {
    let str = '<ul>'
 ...
 **/
function getMinNumberOfArray(array) {
